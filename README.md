...
## LLL (Dr. Raj Dandekar)
* [Lecture 1: Building LLMs from scratch: Series introduction](https://www.youtube.com/watch?v=Xpr8D6LeAtw)
* [Lecture 2: Large Language Models (LLM) Basics](https://www.youtube.com/watch?v=3dWzNZXA8DY)
* [Lecture 3: Pretraining LLMs vs Finetuning LLMs](https://www.youtube.com/watch?v=-bsa3fCNGg4)
* [Lecture 4: What are transformers?](https://www.youtube.com/watch?v=NLn4eetGmf8)
* [Lecture 5: How does GPT-3 really work?](https://www.youtube.com/watch?v=xbaYCf2FHSY)
* [Lecture 6: Stages of building an LLM from Scratch](https://www.youtube.com/watch?v=z9fgKz1Drlc)
* [Lecture 7: Code an LLM Tokenizer from Scratch in Python](https://www.youtube.com/watch?v=rsy5Ragmso8)
* [Lecture 8: The GPT Tokenizer: Byte Pair Encoding](https://www.youtube.com/watch?v=fKd8s29e-l4)
* [Lecture 9: Creating Input-Target data pairs using Python DataLoader](https://www.youtube.com/watch?v=iQZFH8dr2yI)
